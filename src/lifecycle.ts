...
export const FORK_STATE_DIRS = ['.claude', '.codex', '.copilot', '.config', '.pi', '.grok', '.gemini', '.qwen', '.kimi-code', '.local/share/mimocode', '.augment', '.cursor', '.config/devin', '.local/share/devin', '.kiro', '.aider'];
